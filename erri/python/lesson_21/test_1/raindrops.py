...
def convertir(nombre):
    ...
    Si le nombre est divisible par 3, alors il ajoute la chaine de caractères "Pling" au résultat
    Si le nombre est divisible par 5, alors il ajoute la chaine de caractères "Plang" au résultat
    Si le nombre est divisible par 7, alors il ajoute la chaine de caractères "Plong" au résultat
    ...
    if est_divisible_par_3(nombre):
        resultat = resultat + "Pling"

    if est_divisible_par_5(nombre):
        resultat = resultat + "Plang"

    if est_divisible_par_7(nombre):
        resultat = resultat + "Plong"
