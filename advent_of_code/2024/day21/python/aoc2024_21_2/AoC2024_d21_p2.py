...
if __name__ == "__main__":
    ...
    print("data:", data)
    # number of keypads : 1 numeric keypad, 25 directional keypads operated by robots, 1 directional keypad operated by a human
    print(sum(compute_complexity(code, 1 + 25 + 1) for code in data))
