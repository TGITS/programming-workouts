...
public class FizzBuzzTest {
	...
	public void testTransformNumber2(){
		FizzBuzz fb = new FizzBuzz();
		TransformationRule tr_fizz = new TransformationRule(2, "FUZZ");
		fb.addTransformationRule(tr_fizz);
		TransformationRule tr_buzz = new TransformationRule(7,"BIZZ");
		fb.addTransformationRule(tr_buzz);
		TransformationRule tr_fizzbuzz = TransformationRule.compose(tr_fizz, tr_buzz);
		fb.addTransformationRule(tr_fizzbuzz);
	...
	/**
	 * Test method for {@link FizzBuzz#transform(java.util.List)}.
	 */
	@Test
