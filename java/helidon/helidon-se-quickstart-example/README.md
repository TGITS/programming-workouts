...
```bash
mvn package
java -jar target/helidon-se-quickstart-example.jar
```
...
```
./target/helidon-se-quickstart-example
```
...
```
docker build -t helidon-se-quickstart-example .
```

## Running the Docker Image

```
docker run --rm -p 8080:8080 helidon-se-quickstart-example:latest
```
...
kubectl get service  helidon-se-quickstart-example                     # Get service info
kubectl port-forward service/helidon-se-quickstart-example 8081:8080   # Forward service port to 8081
```
...
The target/helidon-se-quickstart-example-jri directory is a self contained custom image of your application. It contains your application,
its runtime dependencies and the JDK modules it depends on. You can start your application using the provide start script:

```
./target/helidon-se-quickstart-example-jri/bin/start
```
