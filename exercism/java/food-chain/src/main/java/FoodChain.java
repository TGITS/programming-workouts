...
public class FoodChain {
    ...
    public static final String WRIGGLED = "%s wriggled and jiggled and tickled inside her.";
    ...
    public String verse(int verse) {
        ...
        if(verse == 3) {
            ...
            for(int i = verse-1; i > 1 ; i--) {
                if(!ANIMAL_BY_VERSE[i-2].equals("spider")) {
                    sb.append(String.format(SHE_SWALLOWED_TO, ANIMAL_BY_VERSE[i - 1], ANIMAL_BY_VERSE[i - 2]));
                } else {
                    sb.append(String.format(SHE_SWALLOWED_TO, ANIMAL_BY_VERSE[i - 1], ANIMAL_BY_VERSE[i - 2]));
                }
                sb.append("\n");
