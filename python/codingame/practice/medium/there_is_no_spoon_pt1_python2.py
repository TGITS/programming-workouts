...
print >> sys.stderr, "width : {} - height : {}".format(width,height)
pp=pprint.PrettyPrinter(stream=sys.stderr)
print >> sys.stderr, "The grid :"
pp.pprint(grid)
print >> sys.stderr, "The cell to process before association :"
pp.pprint(to_process)

for cell in to_process:
    associateNeighbors(grid,cell,height,width)

print >> sys.stderr, "The cell to process after association :"
pp.pprint(to_process)
